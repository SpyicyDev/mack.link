                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                  ...
                  <div className="sm:hidden relative self-start mt-2" role="group" aria-label={`Actions for ${shortcode}`}>
                    <button
                      ...
                      className="p-3 min-h-[44px] min-w-[44px] text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded"
                    ...
                    {openMenuFor === shortcode && (
                      <div className="absolute right-0 mt-2 w-44 max-h-[60vh] overflow-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg z-20" role="menu">
                        <button
