        ...
        <div className="p-6">
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              ...
              className={`px-4 py-3 sm:py-2 text-sm font-medium text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors ${typeStyles[type].confirmButton}`}
            >
              {confirmText}
            </button>
          </div>
