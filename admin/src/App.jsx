...
<main id="main-content" className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 pt-2 xs:pt-3 sm:pt-6 lg:pt-8 content-pb-safe sm:pb-8" role="main">
          <div className="sm:flex sm:items-center sm:justify-between mb-4 xs:mb-6 sm:mb-8">
            <header>
              <h1 className="text-xl xs:text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Link Management</h1>
              <p className="mt-1 xs:mt-1 sm:mt-2 text-sm text-gray-700 dark:text-gray-300">
                Manage your short links and view analytics
              </p>
            </header>
          ...
          <div className="mb-3 xs:mb-4 sm:mb-6 hidden sm:block">
          ...
          <button
            onClick={() => setShowCreateForm(true)}
            className="sm:hidden fixed fab-offset right-3 xs:right-4 sm:right-5 z-50 rounded-full p-3 xs:p-3.5 sm:p-4 shadow-lg bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 active:scale-95 transition-all touch-target"
            aria-label="Create new short link"
          >
            <Plus className="w-5 h-5 xs:w-6 xs:h-6 sm:w-6 sm:h-6" />
          </button>
