          ...
          <div>
            ...
            <div className="mt-1 relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <span className="text-gray-500 text-sm">link.mackhaymond.co/</span>
              </div>
              <input
                type="text"
                name="shortcode"
                ...
                className="block w-full pl-32 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                placeholder="abc123"
                required
              />
            </div>
