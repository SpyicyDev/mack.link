...
export async function recordClick(env, request, shortcode, destinationUrl = '') {
	try {
		...
		// Parse UTM parameters from destination URL
		const utmParams = parseUTMParams(destinationUrl);
